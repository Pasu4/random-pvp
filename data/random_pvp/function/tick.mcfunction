...
bossbar set minecraft:time name [{"nbt":"Minutes", "storage": "timer", interpret: true}, {"score": {"name": "Minutes", "objective": "var"}}, {"text": ":"}, {"nbt":"Seconds", "storage": "timer", interpret: true}, {"score": {"name": "Seconds", "objective": "var"}}]
